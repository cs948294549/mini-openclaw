...
# 获取真实屏幕尺寸（锁屏后依然有效）
SCR_W = windll.user32.GetSystemMetrics(78)
SCR_H = windll.user32.GetSystemMetrics(79)
...
def capture_screen():
    try:
        ...
        return np.zeros((SCR_H, SCR_W, 3), dtype=np.uint8)
...
# 主程序
def main():
    # ✅【修复点】正确的 socket 写法，Windows 100% 兼容
